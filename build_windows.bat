...
cl %CommonCLFlags% -Fo:output\ -Fe:neige neige.cpp %MicrosCLFlags% %HIDAPIProducts% -nologo -EHsc -FC -DOS=OS_WINDOWS -DCPU=CPU_IA64 -DNEIGE_SLOW %CLWarnings%